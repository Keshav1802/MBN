...
import 'package:mothering_business_network/models/InterChapterListAdd.dart';
...
class InterChapterListAdd extends StatefulWidget {
  String user_id;
  // String city_id;
  // String chapter_id;
  ...
  InterChapterListAdd(
      this.user_id, this.chapterDetails, this.chapterUserDetails);

  @override
  State<InterChapterListAdd> createState() => _InterChapterListAddState();
}

class _InterChapterListAddState extends State<InterChapterListAdd> {
  ...
  Future<void> postRequest() async {
    var url = 'https://mbnindia.com/webservice/api/interChapterAdd';
    ...
    FormData formData = FormData.fromMap({
      ...
      'meeting_user_id': chapterUsersId,
      'chepter_id': chapterId,
      'city_id': cityId,
    ...
    if (response.statusCode == 200) {
      if (InterChapterListAddModel.fromJson(jsonObject).status == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
            "Interchapter Added Successfully",
      ...
      } else if (InterChapterListAddModel.fromJson(jsonObject).status == 400) {
        setState(() {
          Timer(Duration(seconds: 1), () {
            _btnController.error();
          });
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content:
                Text(InterChapterListAddModel.fromJson(jsonObject).message),
      ...
      print(InterChapterListAddModel.fromJson(jsonObject).toString());
