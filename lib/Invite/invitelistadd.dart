...
class InviteListAdd extends StatefulWidget {
  String user_id;
  String city_id;
  String chapter_id;

  InviteListAdd(this.user_id, this.city_id, this.chapter_id);

  @override
  State<InviteListAdd> createState() => _InviteListAddState();
}

class _InviteListAddState extends State<InviteListAdd> {
