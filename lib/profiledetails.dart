            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  padding:
                      EdgeInsets.fromLTRB(21 * fem, 46 * fem, 21 * fem, 23 * fem),
                  width: double.infinity,
                  height: 100 * fem,
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                ...
                Container(
                  ...
                  padding:
                      EdgeInsets.fromLTRB(20 * fem, 30 * fem, 0 * fem, 50 * fem),
                  width: double.infinity,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                Align(
                                  child: Text(
                                    widget.logindata.designationName,
                                    textAlign: TextAlign.center,
                                    style: SafeGoogleFont(
                                      'Poppins Medium',
                                      fontSize: 16 * ffem,
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Container(
                                            // autogroupsbhuSAo (L65L2ciPWv4GkJWr4wsbHu)
                                                ...
                                                Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        onTap:(){
                              _callNumber(widget.logindata.mobileNumber);
                                                },
                                                        child: Row(
                                                          children: [
                                                            Container(
                                                      ...
                                                      InkWell(
                                                        onTap: () async {
                                                          final Uri params = Uri(
                                                            scheme: 'mailto',
                                                            path: widget.logindata.email, //add subject and body here
                                                          );
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                      text:
                                      widget.logindata.gst!=null?widget.logindata.gst:"No data present",
                                      style: SafeGoogleFont(
                                        'Poppins',
                                        fontSize: 15 * ffem,
                                        fontWeight: FontWeight.w400,
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                      text:
                                      widget.logindata.businessCategory,
                                      style: SafeGoogleFont(
                                        'Poppins',
                                        fontSize: 15 * ffem,
                                        fontWeight: FontWeight.w400,
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                      text:
                                      widget.logindata.yearsEstablishment,
                                      style: SafeGoogleFont(
                                        'Poppins',
                                        fontSize: 15 * ffem,
                                        fontWeight: FontWeight.w400,
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                      text:
                                      widget.logindata.businessClassification,
                                      style: SafeGoogleFont(
                                        'Poppins',
                                        fontSize: 15 * ffem,
                                        fontWeight: FontWeight.w400,
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                      text:
                                      widget.logindata.businessPresence,
                                      style: SafeGoogleFont(
                                        'Poppins',
                                        fontSize: 15 * ffem,
                                        fontWeight: FontWeight.w400,
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                      text:
                                      widget.logindata.businessInformation!=""?widget.logindata.businessInformation:"No data present",
                                      style: SafeGoogleFont(
                                        'Poppins',
                                        fontSize: 15 * ffem,
                                        fontWeight: FontWeight.w400,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  widget.logindata.instagram!=""?widget.logindata.instagram:'No data present',
                                  style: SafeGoogleFont(
                                    'Poppins',
                                    fontSize: 15 * ffem,
                                    fontWeight: FontWeight.w400,
