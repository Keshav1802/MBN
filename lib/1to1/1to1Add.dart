...
import 'package:mothering_business_network/models/1to1Add.dart';
...
class oneToOneAddPage extends StatefulWidget {
  String user_id;
  // String city_id;
  // String chapter_id;
  ...
  oneToOneAddPage(this.user_id, this.chapterDetails, this.chapterUserDetails);

  @override
  State<oneToOneAddPage> createState() => _oneToOneAddPageState();
}

class _oneToOneAddPageState extends State<oneToOneAddPage> {
  ...
  Future<void> postRequest() async {
    var url = 'https://mbnindia.com/webservice/api/oneToOneAdd';
    ...
    FormData formData = FormData.fromMap({
      ...
      'description': controller.getText(),
      // 'fcm_token': token,
    });
    ...
    if (response.statusCode == 200) {
      if (oneToOneAddModel.fromJson(jsonObject).status == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
            "1 to 1 Meet Added Successfully",
      ...
      } else if (oneToOneAddModel.fromJson(jsonObject).status == 400) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(oneToOneAddModel.fromJson(jsonObject).message),
      ...
      print(oneToOneAddModel.fromJson(jsonObject).toString());
