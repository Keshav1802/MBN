...
class topUsersDetails extends StatefulWidget {
  dash.RecentUser userdata;
  topUsersDetails(this.userdata);
  @override
  State<topUsersDetails> createState() => _topUsersDetailsState();
}

class _topUsersDetailsState extends State<topUsersDetails> {
  @override
